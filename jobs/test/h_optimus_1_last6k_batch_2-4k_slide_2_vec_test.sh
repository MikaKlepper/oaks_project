...
#SBATCH --job-name="l-h_optimus_1_last6k_batch_2-4k"
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-h_optimus_1_last6k_batch_2-4k.out
...
echo "RUNNING SLIDE2VEC WITH H-OPTIMUS-1 ON LAST 6K (BATCH 2-4K) SET"

REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_h_optimus_1_last6k_batch_2-4k.yaml"

SCRATCH_BASE="/scratch_mikaklepper_test"
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/H_OPTIMUS_1_last6k/batch_2-4k"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Tests_FM/H_OPTIMUS_1_last6k/batch_2-4k"
