...
#SBATCH --job-name="l-h_optimus_1_last6k"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-h_optimus_1_last6k.out
...
echo "RUNNING SLIDE2VEC WITH H-OPTIMUS-1 ON LAST 6K SET"

REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_h_optimus_1_last6k.yaml"

SCRATCH_BASE="/scratch_mikaklepper_test"
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/H_OPTIMUS_1_last6k"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Tests_FM/H_OPTIMUS_1_last6k"
