...
#SBATCH --job-name="l-hibou_b"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-hibou_b.out
...
echo "RUNNING SLIDE2VEC WITH HIBOU_B ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_hibou_b.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/HIBOU_B"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/HIBOU_B"
...
# setup environment
export HF_TOKEN="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"
...
echo " Slide2Vec HIBOU_B job completed successfully."
