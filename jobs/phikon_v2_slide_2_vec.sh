...
echo "RUNNING SLIDE2VEC WITH PHIKON_V2 ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_phikonv2.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PHIKON_V2"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PHIKON_V2"
...
# setup environment
export HF_TOKEN="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"
