...
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-benchmark_miccai_test_CLAM.out
...
echo "[INFO] Running benchmark_test_CLAM.py..."
python benchmark_test_CLAM.py
