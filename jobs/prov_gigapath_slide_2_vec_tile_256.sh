...
#SBATCH --job-name="l-prov_gigapath_tile_256"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prov_gigapath_tile_256.out
...
#SBATCH --qos=low
#SBATCH --requeue
#SBATCH --nodelist=dlc-zapdos

echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH TILE (256) ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prov_gigapath_tile_256.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PROV_GIGAPATH_256_TILE"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PROV_GIGAPATH_256_TILE"
...
# setup environment
export HF_TOKEN="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"
...
# optional: pre-download PROV-GIGAPATH model to shared cache (prevents multi-GPU race)
# python3 - <<'PY'
# from huggingface_hub import snapshot_download
# snapshot_download("MahmoodLab/PROV-GIGAPATH", cache_dir="/scratch_mikaklepper_val/hf_cache")
# PY
...
echo " Slide2Vec PROV-GIGAPATH TILE (256) job completed successfully."
