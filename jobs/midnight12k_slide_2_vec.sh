...
#SBATCH --job-name="l-midnight12k"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-midnight12k.out
...
echo "RUNNING SLIDE2VEC WITH MIDNIGHT-12K ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_midnight12k.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/MIDNIGHT12K"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/MIDNIGHT12K"
...
echo " Slide2Vec MIDNIGHT-12K job completed successfully."
