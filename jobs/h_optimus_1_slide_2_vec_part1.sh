...
#SBATCH --job-name="l-h_optimus_1_missing_slides_part_1"
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-h_optimus_1_missing_slides_part_1.out
...
echo "RUNNING SLIDE2VEC WITH H-OPTIMUS-1 ON TG-GATES DATASET (missing slides PART 1)"


REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_h_optimus_1_part1.yaml"

SCRATCH_BASE="/scratch_mikaklepper_tg_gates"
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/H_OPTIMUS_1"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/Missing_slides_FM/features_part_1/H_OPTIMUS_1"
...
echo "Slide2Vec H-OPTIMUS-1 missing slides part1 job completed successfully."
