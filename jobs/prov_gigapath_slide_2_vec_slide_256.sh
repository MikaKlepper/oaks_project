...
#SBATCH --job-name="l-prov_gigapath_256_slide"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prov_gigapath_256_slide.out
...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH SLIDE (256) ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prov_gigapath_slide_256.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PROV_GIGAPATH_256_SLIDE"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PROV_GIGAPATH_256_SLIDE"
...
echo " Slide2Vec PROV-GIGAPATH SLIDE (256) job completed successfully."
