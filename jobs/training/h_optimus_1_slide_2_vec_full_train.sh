...
#SBATCH --job-name="l-h_optimus_1_full_train"
...
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_h_optimus_1_train.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/H_OPTIMUS_1_full"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Trainings_FM/H_OPTIMUS_1_full"
