...
#SBATCH --job-name="l-ctranspath"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-ctranspath.out
...
echo "RUNNING SLIDE2VEC WITH CtransPath ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_ctranspath.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/CTRANSPATH"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/CTRANSPATH"
...
export PYTHONPATH="/data/temporary/mika/repos/TransPath:$PYTHONPATH"
...
python3 -m pip install git+https://github.com/lilab-stanford/MUSK.git git+https://github.com/Mahmoodlab/CONCH.git
...
echo " Slide2Vec CTRANSPATH job completed successfully."
