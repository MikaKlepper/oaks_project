...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH SLIDE (256) ON TRAINING SET"
...
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Trainings_FM/PROV_GIGAPATH_256_SLIDE"
