...
echo "RUNNING SLIDE2VEC WITH VIRCHOW2 ON TRAINING SET"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/VIRCHOW2"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Trainings_FM/VIRCHOW2"
...
echo " Slide2Vec VIRCHOW2 job completed successfully."
