...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH SLIDE-LEVEL (224) ON TRAINING SET"
...
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Trainings_FM/PROV_GIGAPATH_224_SLIDE"
