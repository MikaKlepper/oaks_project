...
echo "RUNNING SLIDE2VEC WITH H-OPTIMUS-0 ON TRAINING SET"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/H_OPTIMUS_0"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Trainings_FM/H_OPTIMUS_0"
