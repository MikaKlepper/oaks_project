...
#SBATCH --job-name="l-h_optimus_1_missing_slides_part_3"
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-h_optimus_1_missing_slides_part_3.out
...
echo "RUNNING SLIDE2VEC WITH H-OPTIMUS-1 ON TG-GATES DATASET (missing slides PART 3)"


REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_h_optimus_1_part3.yaml"
...
echo "Slide2Vec H-OPTIMUS-1 missing slides part3 job completed successfully."
