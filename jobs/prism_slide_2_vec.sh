...
#SBATCH --job-name="l-prism"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prism.out
...
echo "RUNNING SLIDE2VEC WITH PRISM ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prism.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PRISM"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PRISM"
...
# setup environment
export HF_TOKEN="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"
...
echo "[Pre-install] Downloading PRISM ..."
python3 - <<'PY'
from huggingface_hub import snapshot_download
snapshot_download("paige-ai/PRISM", cache_dir="/scratch_mikaklepper_val/hf_cache")
print("[Pre-install] PRISM cached locally.")
PY
...
echo " Slide2Vec PRISM job completed successfully."
