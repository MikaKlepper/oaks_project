...
export HF_TOKEN="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"
export HF_HOME="/tmp"
...
CONFIG_PATH="/data/temporary/mika/repos/oaks_project/slide_2_vec/yaml_configs/liver_prov_gigapath.yaml"
