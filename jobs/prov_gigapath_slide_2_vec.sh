...
#SBATCH --job-name="l-prov_gigapath"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prov_gigapath.out
...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prov_gigapath.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PROV_GIGAPATH"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PROV_GIGAPATH"
...
echo " Slide2Vec PROV-GIGAPATH job completed successfully."
