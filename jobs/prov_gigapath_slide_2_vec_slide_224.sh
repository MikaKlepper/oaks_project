...
#SBATCH --job-name="l-prov_gigapath_224_slide"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prov_gigapath_224_slide.out
...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH SLIDE-LEVEL (224) ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prov_gigapath_slide_224.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PROV_GIGAPATH_224_SLIDE"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PROV_GIGAPATH_224_SLIDE"
...
echo " Slide2Vec PROV-GIGAPATH SLIDE LEVEL (224) job completed successfully."
