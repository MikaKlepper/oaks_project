...
#SBATCH --job-name="l-hibou_L"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-hibou_L.out
...
echo "RUNNING SLIDE2VEC WITH HIBOU_L ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_hibou_l.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/HIBOU_L"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/HIBOU_L"
...
# setup environment
export HF_TOKEN="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"
...
echo " Slide2Vec HIBOU_L job completed successfully."
