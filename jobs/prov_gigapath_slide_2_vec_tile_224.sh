...
#SBATCH --job-name="l-prov_gigapath_tile_224"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-prov_gigapath_tile_224.out
...
echo "RUNNING SLIDE2VEC WITH PROV-GIGAPATH TILE (224) ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_prov_gigapath_tile_224.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PROV_GIGAPATH_224_TILE"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PROV_GIGAPATH_224_TILE"
...
echo " Slide2Vec PROV-GIGAPATH TILE (224) job completed successfully."
