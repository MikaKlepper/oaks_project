...
#SBATCH --job-name="l-resnet50"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-resnet50.out
...
echo "RUNNING SLIDE2VEC WITH RESNET-50 ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_ResNet50.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/RESNET50"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/RESNET50"
...
# setup environment
export HF_TOKEN="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"
...
echo " Slide2Vec RESNET50 job completed successfully."
