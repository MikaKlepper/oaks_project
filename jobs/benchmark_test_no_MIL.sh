...
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-benchmark_miccai_test_NO_MIL.out
...
echo "[INFO] Running benchmark_test_no_MIL.py..."
python benchmark_test_no_MIL.py
