...
#SBATCH --job-name="l-phikon"
#SBATCH --output=/data/temporary/mika/repos/oaks_project/logs/slurm-%j-l-phikon.out
...
echo "RUNNING SLIDE2VEC WITH PHIKON ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_phikon.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/PHIKON"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/PHIKON"
...
# setup environment
export HF_TOKEN="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"
...
echo " Slide2Vec Phikon job completed successfully."
