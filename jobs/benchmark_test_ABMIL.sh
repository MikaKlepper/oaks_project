...
#SBATCH --output=/data/pathology/projects/mika/repos/oaks_project/logs/slurm-%j-l-abmil-benchmark_miccai_test.out
...
echo "[INFO] Running benchmark_test_ABMIL.py..."
python benchmark_test_ABMIL.py
