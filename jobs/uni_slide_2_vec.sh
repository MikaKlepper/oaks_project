...
echo "RUNNING SLIDE2VEC WITH UNI ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_uni.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/UNI"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/UNI"
...
echo " Slide2Vec UNI job completed successfully."
