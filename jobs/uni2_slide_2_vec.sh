...
echo "RUNNING SLIDE2VEC WITH UNI2 ON VALIDATION SET"

# paths
REPO_DIR="/data/temporary/mika/repos/oaks_project/slide_2_vec"
CONFIG_PATH="$REPO_DIR/yaml_configs/liver_uni2.yaml"
...
SCRATCH_OUTPUT_DIR="$SCRATCH_BASE/outputs/UNI_2"
FINAL_OUTPUT_DIR="/data/temporary/toxicology/TG-GATES/liver/Validations_FM/UNI_2"
...
echo " Slide2Vec UNI2 job completed successfully."
